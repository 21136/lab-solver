...
**导出时间**：2026-06-03（已合并 DeepSeek **附录 B + 附录 D**；见 [deepseek的建议.md](../reference/deepseek的建议.md)）  
**实现进度**：Phase 1～3 主体已落地；详见 [IMPLEMENTATION_PHASES.md](../architecture/IMPLEMENTATION_PHASES.md) §四  
**完整计划正文**：[`../architecture/LAB_SOLVER_AGENT_PLAN.md`](../architecture/LAB_SOLVER_AGENT_PLAN.md)（与 Cursor 计划同步）  
**分阶段实施（推荐先看）**：[`../architecture/IMPLEMENTATION_PHASES.md`](../architecture/IMPLEMENTATION_PHASES.md)  
...
| 文件 | 用途 |
|------|------|
| `../architecture/LAB_SOLVER_AGENT_PLAN.md` | 完整计划（给 AI / 团队评审） |
| `PLAN_EXPORT_README.md` | 本说明 + 提问模板 |
| `../architecture/IMPLEMENTATION_PHASES.md` | V1 分阶段实施与当前进度 |
| `NEXT_VERSION_BACKLOG.md` | **下一版 v2**：核心项 + **盲区/O7–O31**（§二） |
| `../v2/V2_DOC_TEMPLATE_ADAPTATION.md` | **v2 高优**：表格实训、节号不统一（DA1–DA4） |
| `../v2/V2_IMAGE_INPUT.md` | **v2 高优**：图片/多图识题（IM1 ✅、IM2-a ✅；IM2-b–IM5 待做） |
