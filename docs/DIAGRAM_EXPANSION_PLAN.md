...
**关联**：[LAB_SOLVER_AGENT_PLAN.md](./LAB_SOLVER_AGENT_PLAN.md) · [AGENT_ARCHITECTURE_V3.md](./AGENT_ARCHITECTURE_V3.md) · [V2_DOC_TEMPLATE_ADAPTATION.md](./V2_DOC_TEMPLATE_ADAPTATION.md) · `src/python/assets/README.txt`（PlantUML 本地渲染）
...
1. 在 [NEXT_VERSION_BACKLOG.md](./NEXT_VERSION_BACKLOG.md) 增加条目 **「图表扩展 DG1–DG3」** 指向本文。  
2. [IMPLEMENTATION_PHASES.md](./IMPLEMENTATION_PHASES.md) 新增一节「Phase DG」。  
